		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Create Search_filter panel using HBOX and VBOX",
									"targetURL": "#r4searchproducthboxvbox-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"r4searchproducthboxvbox-display": {
								"semanticObject": "r4searchproducthboxvbox",
								"action": "display",
								"description": "Create Search options using HBOX and VBOX",
								"title": "Create Search_filter panel using HBOX and VBOX",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=r4searchproducthboxvbox",
									"url": sap.ui.require.toUrl("r4searchproducthboxvbox")
								}
							}
						}
					}
